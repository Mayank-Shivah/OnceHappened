...
export default function FontSizeChanger() {
  ...
  // Apply font size to <html> inline style
  const applyFontToHtml = (size) => {
    const html = document.documentElement;
    html.style.fontSize = size + "px"; // direct override
    html.style.setProperty("--app-font-size", size + "px"); // CSS var
  };
  ...
  // --- Removed scroll effect to disable scroll-driven size changes ---
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                <polygon
                  points="13,2 24,8.5 24,19.5 13,26 2,19.5 2,8.5"
                  fill="#fff"
                  stroke="#bbb"
                  strokeWidth="2"
                />
                <polygon
                  points="13,4 22,9 22,19 13,24 4,19 4,9"
                  fill="#ffe066"
                  opacity="0.82"
                />
              </svg>
